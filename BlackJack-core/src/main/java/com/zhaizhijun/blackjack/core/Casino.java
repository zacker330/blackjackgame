...
public class Casino {
    ...
    public static void signUp(Player... players) {
        assert players != null;
    ...
    public static boolean isSignUpped(Player player) {
     ...
     *          没有足够的钱下注
     */
    public synchronized static void bet(Player player, BigDecimal amount) {
    ...
    public static boolean isEnoughMoneyToBet(Player player, BigDecimal bet) {
    ...
    public static void joinTable(int tableId, Player... players) {
        assert players != null;
    ...
    public static BigDecimal queryBank(Player player) {
        assert player != null;
    ...
    public static boolean isDoubleDownAbility(Player player, BigDecimal betAmount) {
