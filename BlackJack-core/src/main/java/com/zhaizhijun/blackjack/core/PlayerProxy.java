...
public class PlayerProxy extends PartyProxy {
    ...
    protected PlayerProxy(Player player) {
        super(player);
    }

    protected PlayerProxy(Player player, BigDecimal amountOfBet) {
        super(player);
    ...
    public PlayerProxy split() {
        ...
        PlayerProxy result = getPlayer().createPlayerProxy(getBetMoney());
