...
public class JoinMapping {
    ...
    private static Map<Integer, SortedSet<Player>> mapping = new HashMap<Integer, SortedSet<Player>>();
     ...
     */
    protected static void join(Integer tableId, Player player) {
     ...
     * @return
     */
    protected static Integer wherePlayerIn(Player player) {

        for (Integer each : mapping.keySet()) {
            SortedSet<Player> players = mapping.get(each);
     ...
     */
    protected static Set<Player> whoAtTables(Integer tableId) {
    ...
    protected static boolean hadJoin(Player player) {
    ...
    protected static void initSomeIds(Integer... ids) {
        ...
        for (Integer id : ids) {
            mapping.put(id, new TreeSet<Player>());
        }
